...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.structure'
        db.add_column('tournaments_match', 'structure', self.gf('django.db.models.fields.CharField')(default='I', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Match.structure'
        db.delete_column('tournaments_match', 'structure')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 12, 29, 12, 755000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
