...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tournaments_tournament', 'game',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Game'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tournaments.tournament': {
            ...
            'game': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['api.Game']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
