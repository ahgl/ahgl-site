...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.karma'
        db.add_column('profiles_team', 'karma', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Team.karma'
        db.delete_column('profiles_team', 'karma')
