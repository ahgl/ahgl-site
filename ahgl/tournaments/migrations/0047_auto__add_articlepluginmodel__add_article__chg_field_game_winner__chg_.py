...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('tournaments_article')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 3, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tournaments.articlepluginmodel': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tournaments.Article']", 'unique': 'True'}),
