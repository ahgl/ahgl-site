...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for memberprofile in orm['profiles.TeamMembership'].objects.all():
            memberprofile.questions_answers = memberprofile.questions_answers.replace("""<li>
<p>What is your Heart of the Swarm beta character code and ID?</p>
<p>-</p>
</li>""","")
            orm['profiles.TeamMembership'].objects.filter(pk=memberprofile.pk).update(questions_answers=memberprofile.questions_answers)
