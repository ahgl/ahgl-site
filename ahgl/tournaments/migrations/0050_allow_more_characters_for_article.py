...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tournaments_article', 'title', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Article.summary'
        db.alter_column('tournaments_article', 'summary', self.gf('tinymce.models.HTMLField')(max_length=4000))
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
