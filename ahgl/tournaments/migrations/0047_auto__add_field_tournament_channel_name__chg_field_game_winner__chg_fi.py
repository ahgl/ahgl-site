...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.channel_name'
        db.add_column('tournaments_tournament', 'channel_name',
    ...
    def backwards(self, orm):
        # Deleting field 'Tournament.channel_name'
        db.delete_column('tournaments_tournament', 'channel_name')
