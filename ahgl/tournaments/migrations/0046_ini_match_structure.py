...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for match in orm['tournaments.Match'].objects.select_related('tournament'):
            match.structure = match.tournament.structure
            match.save()
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 12, 29, 29, 299000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
