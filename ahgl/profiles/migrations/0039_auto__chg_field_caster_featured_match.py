...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Caster.featured_match'
        db.alter_column('profiles_caster', 'featured_match_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tournaments.Match']))

    def backwards(self, orm):

        # Changing field 'Caster.featured_match'
        db.alter_column('profiles_caster', 'featured_match_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['tournaments.Match']))
    ...
    models = {
        ...
        'profiles.caster': {
            ...
            'description': ('profiles.fields.HTMLField', [], {'attributes': '[]', 'blank': 'True', 'tags': '[]'}),
