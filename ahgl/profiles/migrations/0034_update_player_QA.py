...
<p>-</p>
    ...
    def forwards(self, orm):
        ...
        for memberprofile in orm['profiles.TeamMembership'].objects.all():
            if memberprofile.questions_answers == self.OLD_QA:
                memberprofile.questions_answers = self.NEW_QA
                memberprofile.save()
    ...
    def backwards(self, orm):
        ...
        for memberprofile in orm['profiles.TeamMembership'].objects.all():
            if memberprofile.questions_answers == self.NEW_QA:
                memberprofile.questions_answers = self.OLD_QA
                memberprofile.save()
