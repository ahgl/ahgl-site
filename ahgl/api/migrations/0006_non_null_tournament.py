...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.tournament'
        db.alter_column('api_game', 'tournament_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tournaments.Tournament']))

    def backwards(self, orm):

        # Changing field 'Game.tournament'
        db.alter_column('api_game', 'tournament_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tournaments.Tournament'], null=True, on_delete=models.SET_NULL))
