...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.victory_screen'
        db.alter_column('tournaments_game', 'victory_screen', self.gf('django.db.models.fields.files.ImageField')(max_length=300, null=True))


    def backwards(self, orm):
        
        # Changing field 'Game.victory_screen'
        db.alter_column('tournaments_game', 'victory_screen', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 9, 12, 40, 25, 371000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
