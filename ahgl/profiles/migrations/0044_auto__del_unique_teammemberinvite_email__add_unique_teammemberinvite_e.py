...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'TeamMemberInvite', fields ['email']
        db.create_unique('profiles_teammemberinvite', ['email'])

        # Deleting field 'TeamMembership.status'
        db.delete_column('profiles_team_members', 'status')
