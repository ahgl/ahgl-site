...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tournament.game'
        db.alter_column('tournaments_tournament', 'game_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['api.Game'], unique=True, null=True))
        # Adding unique constraint on 'Tournament', fields ['game']
        db.create_unique('tournaments_tournament', ['game_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Tournament', fields ['game']
        db.delete_unique('tournaments_tournament', ['game_id'])


        # Changing field 'Tournament.game'
        db.alter_column('tournaments_tournament', 'game_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Game'], null=True))
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
